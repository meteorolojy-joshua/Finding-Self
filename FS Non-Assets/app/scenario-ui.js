...
window.SCENARIO_UI = (() => {
  ...
  function renderList() {
    ...
    $view().innerHTML = `
      <div class="card" data-od-id="scenario-list">
        ...
        <div class="node-title">Scenario Setups</div>
        <h1 class="prompt">Scenario Setups</h1>
        <p class="support">Each scenario is your own copy of a question-and-answer flow. Changes never touch the premade questions.</p>
  ...
  function renderNewScenario() {
    ...
    $view().innerHTML = `
      <div class="card" data-od-id="scenario-new">
        ...
        <div class="node-title">New Scenario Setup</div>
    ...
    $view().innerHTML = `
      <div class="card scn-editor-card" data-od-id="scenario-editor">
        ...
        <div class="scn-canvas">
          ...
          <div class="scn-focus" data-scact="drop-zone" data-ref="${esc(proj.focus_ref)}"><div class="scn-focus-label">Currently Editing:</div><div class="scn-level">${focusBox}</div></div>
  ...
  function confirmDeleteScenario(id) {
    ...
    _modal = { html: `
      ...
      <p class="support">This removes this Scenario Setup and its local changes. It will not delete premade questions, answers, or other Scenario Setups.</p>
